...
<div>
    ...
    <?php endif ?>
    <?php echo form_open('settings/payment_method', array("class"=> "grid grid-cols-2 gap-4"))?>
        <div>
        <label for="position" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Account Name</label>
        <input type="text" name="payment_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block w-full p-2.5" required>
            </div>
            <div>
            <label for="confirmPass" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Account Number <span class="text-red-500"><small class="text-sky-500">(Optional)</small></span>
</label>
<input type="text" name="account_number" placeholder="Eg 553412" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block w-full p-2.5">
