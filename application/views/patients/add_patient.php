...
<div>
    ...
    <?php endif ?>
    <?php echo form_open('patient/create', array("class"=> "grid grid-cols-2 gap-4"))?>
        <div>
        ...
        <div>
            ...
            <input type="text" name="middle_name" id="middleName" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block w-full p-2.5" required>
        </div>
        <div>
        ...
        <div>
            ...
            <input type="number" name="age" id="age" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block w-full p-2.5" required>
        </div>
        <div>
        ...
        <div>
            <label for="patient_status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Patient Status</label>
            <select name="patient_status" class="form-select bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block w-full p-2.5" id="patient_status" required>
                <option value="">Select Status</option>
                <option class="p-4" value="Not Urgent">Not Urgent</option>
                <option class="p-4" value="Special Need">Special Need</option>
                <option class="p-4" value="Special Need">Normal</option>
            </select>
        </div>
        <div>
            <label for="account_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Account Type</label>
            <select name="account_type" class="form-select bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block w-full p-2.5" id="account_type" required>
                <option value="without Insurance">Without Insurance</option>
            </select>
        </div>
        <div>
            <label for="escort" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">An escort</label>
            <input type="text" name="escoter" id="escorter" class="w-9/12 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[hsl(181,99%,43%)] focus:border-[hsl(181,99%,43%)] block" required>
        </div>
        <button type="submit" class="w-1/2 col-span-2 ml-[30%] text-white bg-[#01d8da] hover:bg-[hsl(181,99%,43%)] focus:ring-4 focus:outline-none focus:ring-[hsl(181,99%,43%)] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[hsl(181,99%,43%)] dark:hover:bg-[hsl(181,99%,43%)] dark:focus:ring-[hsl(181,99%,43%)]">Submit</button>
    </form>
</div>
